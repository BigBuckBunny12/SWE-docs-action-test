...
L'attività di analisi dei requisiti ha come obiettivo trasformare i requisiti \term{Utente} espressi nel \term{Capitolato}, nel nostro caso il \textbf{\term{Capitolato} C4} proposto da \textbf{Miriade S.r.l.}, in requisiti di sistema chiari, completi e verificabili. 
...
Se le modifiche implicano la creazione del file di documentazione il membro del gruppo è tenuto a creare il file sorgente, denominato secondo le convenzioni stabilite. Una volta inserito il nuovo file nel \term{Repository} remoto, il sistema provvede automaticamente ad applicare il template comune, garantendo l’integrazione delle componenti strutturali condivise.
...
Per ciascuna metrica vengono inoltre individuati, nel \term{Piano Di Qualifica}, dei valori ottimali o soglie di riferimento, al fine di identificare tempestivamente eventuali comportamenti anomali o scostamenti rispetto agli obiettivi di qualità prefissati.\\
...
\begin{itemize}
    ...
    \item \textbf{Revisione e valutazione}, perché un prodotto entri in \term{Baseline}, le modifiche apportate devono essere prima verificate da un verificatore e successivamente revisionate dal responsabile. Quest’ultimo accerta che i prodotti software e i piani risultino conformi ai requisiti stabiliti, valutando l’esito dei compiti completati e garantendo qualità e coerenza con gli obiettivi del processo.
...
\end{itemize}
L'esito di ogni incontro, interno o esterno, deve essere registrato mediante la redazione di un \term{Verbale}, secondo le modalità previste dal processo di documentazione. 
