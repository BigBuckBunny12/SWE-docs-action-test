...
\begin{itemize}
    ...
    \term{Verbale} disponibile al seguente link: \href{<LINK_VERBALE_ZUCCHETTI>}{\term{Verbale} esterno 2025-10-23}.
    \item \textbf{Ergon Informatica s.r.l.} – discussione sul \term{Capitolato} \emph{C8 Smart Order}.  
    \term{Verbale} disponibile al seguente link: \href{<LINK_VERBALE_ERGON>}{\term{Verbale} esterno 2025-10-27}.
    \item \textbf{Miriade S.p.A.} – incontro per chiarimenti sul \term{Capitolato} \emph{C4 L’app che protegge e trasforma}.  
    \term{Verbale} disponibile al seguente link: \href{<LINK_VERBALE_MIRIADE>}{\term{Verbale} esterno 2025-10-27}.
\end{itemize}
