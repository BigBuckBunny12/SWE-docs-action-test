...
I server ospitano localmente vari modelli LLM (tra 7B e 27B) gestiti tramite \textbf{Ollama}, un framework che permette l’accesso ai modelli via \textbf{\term{Api} endpoint}.  
...
L’interazione con i modelli avverrà tramite un’\term{Api} che consente di:
\begin{itemize}
