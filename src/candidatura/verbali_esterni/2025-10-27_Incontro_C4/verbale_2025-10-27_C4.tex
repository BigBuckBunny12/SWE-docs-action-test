...
Il gruppo ha chiesto chiarimenti sulla gestione dei percorsi sicuri. Non è stata fornita una risposta definitiva sulla necessità di memorizzarli in un \term{Database} o recuperarli da fonti esterne.  
...
L’azienda mette a disposizione le \term{Api} di \textbf{Amazon Bedrock} per l’integrazione dell’intelligenza artificiale.  
