...
Ciascun \term{\term{Componente}} ha espresso la propria preferenza tra i progetti proposti:
\begin{itemize}
...
\\
Il \term{\term{Capitolato}} n.6 per il momento è stato escluso: tutti i partecipanti alla riunione esterna hanno infatti espresso opinioni negative in merito alla direzione presa dal progetto, che sembrava più interessante prima dell'incontro. Anche il referente non ha dato un'impressione positiva.
...
\begin{itemize}
    ...
    \item Infrastruttura e servizi cloud: \textbf{AWS} (Amazon Bedrock, \term{\term{Database}} SQL e NoSQL);
...
\hline
\rowcolor{white}
1.0.0 & 2025-10-28 & Gabriele Scaggiante & Stesura iniziale del \term{\term{Verbale}} & Dennis Parolin \\
\hline
