...
Ciascun \term{Componente} ha espresso la propria preferenza tra i progetti proposti:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Infrastruttura e servizi cloud: \textbf{AWS} (Amazon Bedrock, \term{Database} SQL e NoSQL);
