...
Dopodiché, sono state aggiunte issue ed è stata creata una \term{Milestone} per la \term{Repository}.
...
\section{Decisioni}
\begin{itemize}
    \item Sono state decise delle issue da aggiungere alla \term{Repository}, come la creazione del diario di bordo
...
% ---------- \term{To Do} ----------
\section{\term{To Do}}
Dalle discussioni e decisioni intraprese, sono sorte le seguenti \term{Task}:
...
\hline
\rowcolor{gray!60} 
\textbf{\term{Task}} & \textbf{Assegnatario} & \textbf{Scadenza} \\
\hline
\rowcolor{white}
