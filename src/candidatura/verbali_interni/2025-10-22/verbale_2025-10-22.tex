...
\begin{itemize}
    ...
    \item Aggiornamento \term{\term{Repository}} github
\end{itemize}
...
Dopodiché, sono state aggiunte issue ed è stata creata una \term{\term{Milestone}} per la \term{\term{Repository}}.
...
\section{Decisioni}
\begin{itemize}
    \item Sono state decise delle issue da aggiungere alla \term{\term{Repository}}, come la creazione del diario di bordo
...
\hline
\rowcolor{white}
1.0.0 & 2025-10-22 & Dennis Parolin & Stesura iniziale del \term{\term{Verbale}} & Riccardo Manisi \\
\hline
\end{tabular}
\end{center}
