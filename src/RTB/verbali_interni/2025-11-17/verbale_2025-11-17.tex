...
\hline
\rowcolor{white}
Meno ore in queste prime settimane & VI RTB 2.1 \\
\hline
\rowcolor{gray!20}
Funzionalità da esporre all'azienda &  VI RTB 2.2 \\
\hline
\rowcolor{white}
Domande all'azienda Miriade & VI RTB 2.3 \\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{gray!20}
Preparare documento domande meeting con Miriade & VI RTB 2.3 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/80}{\textbf{issue 80}} \\
\hline
\end{tabular}
\end{center}
