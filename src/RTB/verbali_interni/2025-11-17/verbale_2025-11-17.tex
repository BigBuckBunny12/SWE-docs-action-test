...
\newcommand{\documenttitle}{\term{Verbale} Riunione Numero 2}
...
\begin{itemize}
    ...
    \item Attivazione alert tramite temporizzatori di sicurezza - Timer preimpostati dall'\term{\term{Utente}} per controlli automatici;
    \item Funzionalità di "Check-in" di sicurezza - Timer periodico che invia alert automatico se l'\term{\term{Utente}} non conferma la propria sicurezza;
    ...
    \item Aggiornamento costante banca dati risorse - Sistema di \term{\term{Verifica}} e \term{\term{Validazione}} periodica delle informazioni;
...
\hline
\rowcolor{white}
Diminuzione ore produttive attese per le prime 2 settimane & VI \term{\term{Rtb}} 2.1 \\
\hline
\rowcolor{gray!20}
Creazione di un insieme di funzionalità base da proporre alla'zienda Miriade &  VI \term{\term{Rtb}} 2.2 \\
\hline
\rowcolor{white}
Preparazione di altre domande generiche da fare all'azienda Miriade & VI \term{\term{Rtb}} 2.3 \\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{white}
Elaborare presentazione funzionalità per proponente & VI \term{\term{Rtb}} 2.2 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/81}{\textbf{issue 81}} \\
\hline
\rowcolor{gray!20}
Preparare documento domande generiche e gestione del progetto per il meeting con Miriade & VI \term{\term{Rtb}} 2.3 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/80}{\textbf{issue 80}} \\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{white}
0.2.1 & 25-11-17 & Dennis Parolin & Migliorate le frasi nella sezione Decisioni e \term{\term{To Do}}. Sistemato il versionamento e l'ordine di presentazione delle righe nelle tabelle  & Riccardo Manisi \\
\hline
\rowcolor{gray!20}
