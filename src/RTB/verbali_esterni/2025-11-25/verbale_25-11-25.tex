...
\begin{figure}[H]
    \centering
    % Placeholder per l'immagine. Sostituire con il percorso reale se necessario.
    \framebox{\parbox{0.7\textwidth}{\centering \vspace{3cm} \textbf{Immagine Cartellone Organizzativo} \\ \small (vise_presenta.jpg) \vspace{3cm}}}
    %\includegraphics[width=0.7\textwidth]{nome_della_tua_immagine.jpg}
...
\begin{figure}[H]
    \centering
    % Placeholder per l'immagine. Sostituire con il percorso reale se necessario.
    \framebox{\parbox{0.7\textwidth}{\centering \vspace{3cm} \textbf{Immagine Mockup} \\ \small (tabellone.jpg) \vspace{3cm}}}
    %\includegraphics[width=0.7\textwidth]{nome_della_tua_immagine.jpg}
    \caption{Presentazione delle proposte di UI da parte dei membri del team.}
    \label{fig:mockup}
\end{figure}
