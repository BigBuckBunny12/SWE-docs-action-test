...
\hline
\rowcolor{white}
Esempio \term{Task} 1 & VI C 1.1 & \href{https://github.com/<repo>/issues/1}{\textbf{issue}} \\
\hline
\rowcolor{gray!20}
Esempio \term{Task} 2 & VI C 1.2 & \href{https://github.com/<repo>/issues/2}{\textbf{issue}} \\
\hline
\rowcolor{white}
Esempio \term{Task} 3 & VI C 1.3 & \href{https://github.com/<repo>/issues/3}{\textbf{issue}} \\
\hline
\end{tabular}
\end{center}
