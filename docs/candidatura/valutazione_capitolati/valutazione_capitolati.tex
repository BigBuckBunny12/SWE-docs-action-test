...
\begin{itemize}
    ...
    \item \textbf{Integrazione e gestione dati:} adozione di \term{Database} relazionali (MySQL, PostgreSQL) e \term{Api} REST per la comunicazione tra moduli e l’invio dei dati elaborati ai sistemi ERP aziendali.
